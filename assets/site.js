    ...
    footer.innerHTML = `
      <div class="wrap" style="padding-top:2.25rem;padding-bottom:2.25rem;display:flex;flex-wrap:wrap;gap:1rem;align-items:center;justify-content:space-between">
        ...
        <div style="display:flex;gap:.65rem;align-items:center">
          ...
          <a href="https://github.com/Jim1128" target="_blank" rel="noopener" aria-label="GitHub" style="width:38px;height:38px;border-radius:50%;background:rgba(255,255,255,.06);display:flex;align-items:center;justify-content:center">
